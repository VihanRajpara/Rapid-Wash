...
function Washerman(){
  ...
  const handlesignup = async (sevent) => {
    ...
    if (sigemail === "" || sigpass === "" || signame === "" ||sigadd===""||sigcity===""||sigcon===""||sigpin===""||sigsname==="") {
  ...
  const handlelogin = async (event) => {
    ...
    if (logemail === "" || logpass === "") {
      ...
      await axios
        .post("http://localhost:5000/api/washerman/login", {
          email: logemail,
          password: logpass,
        })
        .then((response) => {
                    ...
                    <div className="card-3d-wrapper">
                      <div className="card-front">
                        <div className="center-wrap">
                          ...
                          <div className="body">
                            <h4 className="mb-4 pb-3 text-2xl">Washerman Log In</h4>
                            </div>
                      ...
                      <div className="card-back">
                        <div className="center-wrap">
                          <div className="section text-center">
                          <div className="body">
                            <h4 className="mb-4 pb-3 text-2xl">Washerman Sign Up</h4>
                            </div>
                            {currentStep === 1 && (
                              <div>
                                <div className="form-group">
                                  <input
                                    ...
                                    id="signame"
                                    value={signame}
                                    onChange={(sevent) => setName(sevent.target.value)}
                                  />
                                ...
                                <div className="form-group mt-2">
                                  <input
                                    ...
                                    id="sigemail"
                                    value={sigemail}
                                    onChange={(sevent) => setSemail(sevent.target.value)}
                                  />
                                  <i className="input-icon uil uil-at"></i>
                                </div>
                                <div className="form-group mt-2">
                                  <input
                                    ...
                                    id="sigpass"
                                    value={sigpass}
                                    onChange={(sevent) => setSpass(sevent.target.value)}
                                  />
                                  <i className="input-icon uil uil-lock-alt"></i>
                                </div>
                                <button
                            ...
                            {currentStep === 2 && (
                              ...
                              <div className="form-group">
                                  <input
                                    ...
                                    id="sigadd"
                                    value={sigadd}
                                    onChange={(sevent) => setAdd(sevent.target.value)}
                                  />
                                ...
                                <div className="form-group mt-2">
                                  <select
                                    ...
                                    className="form-style"
                                    value={sigcity}
                                    onChange={(sevent) => setCity(sevent.target.value)}
                                  >
                                ...
                                <div className="form-group mt-2">
                                  <input
                                    ...
                                    id="sigpin"
                                    value={sigpin}
                                    onChange={(sevent) => setPin(sevent.target.value)}
                                  
                                  />
                                  <i className="input-icon uil uil-map-pin-alt"></i>
                                </div>
                                <button className="btn mt-4" onClick={handleprev}>Previous</button>
                                <button
                                  className="btn mt-4"
                                  onClick={handleNext}
                                >
                            ...
                            {currentStep === 3 && (
                              <div>
                                ...
                                <input
                                    ...
                                    id="sigsname"
                                    value={sigsname}
                                    onChange={(sevent) => setSname(sevent.target.value)}
                                  />
                                ...
                                <div className="form-group mt-2">
                                  <input
                                    ...
                                    id="sigcon"
                                    value={sigcon}
                                    onChange={(sevent) => setCon(sevent.target.value)}
                                  />
                                ...
                                <div className="form-group mt-2">
                                  <input
                                    ...
                                    id="sigcost"
                                    value={sigcost}
                                    onChange={(sevent) => setCost(sevent.target.value)}
                                  />
                                  <i className="input-icon uil uil-rupee-sign"></i>
                                </div>
                                <div><button className="btn mt-4" onClick={handleprev}>Previous</button>
                                <button type='submit' className="btn mt-4" onClick={handlesignup}>submit</button></div>
                              </div>
                            )}
...
export default requireAuthw(Washerman);
